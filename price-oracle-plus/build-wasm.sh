...
DECIMALS="$DECIMALS" RESOLUTION="$RESOLUTION" ADMIN="$ADMIN" BASE_ASSET_TYPE="$BASE_ASSET_TYPE" BASE="$BASE" FEE_ASSET="$FEE_ASSET" cargo build --release --target wasm32-unknown-unknown
